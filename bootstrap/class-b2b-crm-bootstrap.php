...
require_once B2B_CRM_MAROC_PATH . 'database/class-b2b-crm-contact-activity-table.php';
...
require_once B2B_CRM_MAROC_PATH . 'services/class-b2b-crm-contact-activity-repository.php';
...
class B2B_CRM_Bootstrap
{
    ...
    public static function activate()
    {
        ...
        B2B_CRM_Contact_Activity_Table::create_table();
