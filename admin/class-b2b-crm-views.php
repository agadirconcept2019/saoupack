                    ...
                    <?php if ($settings_tab === 'general') : ?>
                        <section class="b2b-crm__settings-section">
                            ...
                            <div class="b2b-crm__settings-fields">
                                ...
                                <div class="b2b-crm__label b2b-crm__logo-url-field">
                                    <label for="b2b-crm-logo-url"><?php echo esc_html__('URL du logo', 'b2b-crm-maroc'); ?></label>
                                    <div class="b2b-crm__settings-row">
                                        <input id="b2b-crm-logo-url" class="b2b-crm__input" type="url" name="logo_url" value="<?php echo esc_attr($settings['logo_url']); ?>" placeholder="https://exemple.com/logo.png" />
                                        <button type="button" class="button b2b-crm__test-logo" data-target="#b2b-crm-logo-url"><?php echo esc_html__('Tester', 'b2b-crm-maroc'); ?></button>
                                    </div>
                                    <p class="b2b-crm__muted"><?php echo esc_html__('Optionnel : laissez vide pour utiliser le fallback texte.', 'b2b-crm-maroc'); ?></p>
                                </div>
                            </div>
                        </section>
